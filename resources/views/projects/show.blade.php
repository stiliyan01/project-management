    ...
    <div class="container my-5">
        <div class="text-center mb-4">
            ...
            <div class="d-flex justify-content-center gap-2">
                <a href="{{ route('projects.edit', ['project' => $project]) }}" class="btn btn-primary mt-3">Edit
                    Project</a>
                ...
                <a href="{{ route('tasks.create', ['project_id' => $project->id]) }}" class="btn btn-success mt-3">Create
                    Task</a>
